//////////////////////////////////////////////////////////////////////////
// SCProductPretreatment.h
// created by zy 20080401
// SC雷达产品数据格式
//////////////////////////////////////////////////////////////////////////
#pragma once
#ifndef CCPRODUCTPRETREATMENT1_H
#define CCPRODUCTPRETREATMENT1_H

#pragma pack(push,1)//这句和下面对应的pop一定要加上，保证对齐

#include "GData.h"
typedef struct TArchive//CINRAD-SC LEVEL II 数据格式
{
...
class CCProductPretreatment1 :	public GenerationData
{
	public:
		CCProductPretreatment1();
		~CCProductPretreatment1();
