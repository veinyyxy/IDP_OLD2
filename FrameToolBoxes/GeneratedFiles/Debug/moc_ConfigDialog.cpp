...
static const char qt_meta_stringdata_ConfigDialog[] = {
    "ConfigDialog\0\0Slot_ButtonClicked()\0"
    "current,previous\0"
...
void ConfigDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->Slot_ButtonClicked(); break;
        case 1: _t->Slot_ChangePage((*reinterpret_cast< QListWidgetItem*(*)>(_a[1])),(*reinterpret_cast< QListWidgetItem*(*)>(_a[2]))); break;
        default: ;
        }
    }
}
