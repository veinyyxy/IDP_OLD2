...
goLinearRing::goLinearRing(void)
{
}

goLinearRing::goLinearRing( geom::Geometry* geometry, CoordinateTransform* pCT /*= 0*/, Layer* pL /*= 0*/ )
...
void goLinearRing::CreateOsgFromGeos(osg::Node* pNode)
{
...
void goLinearRing::SetCoordinateTransform( CoordinateTransform* pCT )
{
	m_pCorrdinateTransform = pCT;
}

void goLinearRing::TransformGeometry()
{
	osg::Vec3 srcVec3, destVec3;
	geom::CoordinateSequence* pCoordinateSequence = m_pGeosGeomtry->getCoordinates();
...
void goLinearRing::operator=( const goLinearRing& other )
{
