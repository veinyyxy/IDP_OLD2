...
static char *opchars[13] = {"!=",">=","<=","|","&","=",">","<","%","+","-","*","/"};
static gaint opvals[13] = {4,6,8,1,2,3,5,7,9,10,11,12,13};
static gaint optyps[15] = {0,0,1,1,1,1,1,1,0,2,2,2,2,0,2};
static gaint opmins[7] = {14,12,10,9,3,2,1};
static gaint opmaxs[7] = {15,13,11,9,8,2,1};
