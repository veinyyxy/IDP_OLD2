	...
	: QDockWidget(parent)
{
	...
	//QtProperty *item =  enumManager->addProperty(tr("线形"));
	//item->setToolTip(tr("线形"));
	//QStringList enumNames;
	//enumNames<<tr("空心")<<tr("实心");
	...
	//item = colorManager->addProperty(tr("颜色"));
	//item->setToolTip(tr("颜色"));
	//colorManager->setValue(item, QColor(86,68,88));
	//m_pPropertyBrowser->addProperty(item);
