...
void QRecentFilesMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        QRecentFilesMenu *_t = static_cast<QRecentFilesMenu *>(_o);
        switch (_id) {
        case 0: _t->recentFileTriggered((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 1: _t->addRecentFile((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: _t->clearMenu(); break;
        case 3: _t->setMaxCount((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->menuTriggered((*reinterpret_cast< QAction*(*)>(_a[1]))); break;
...
const QMetaObjectExtraData QRecentFilesMenu::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QRecentFilesMenu::staticMetaObject = {
    { &QMenu::staticMetaObject, qt_meta_stringdata_QRecentFilesMenu,
      qt_meta_data_QRecentFilesMenu, &staticMetaObjectExtraData }
};
