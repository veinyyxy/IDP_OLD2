...
static const char qt_meta_stringdata_PlotDialog[] = {
    "PlotDialog\0\0Slots_PushButtonClicked()\0"
};
...
const QMetaObjectExtraData PlotDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PlotDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_PlotDialog,
      qt_meta_data_PlotDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PlotDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PlotDialog))
