...
typedef struct IDWParam
{
	...
	IDWParam():weight(0),power(2),bandwidth(1),mode(0),pointMax(12),radius(15),isiz(141),jsiz(81),lonmin(70),lonmax(140),latmin(15),latmax(55),fUndef(-999.0),strange("是")
	{		
...
class STATIONINTERPOLATION_EXPORT InverseDistanceInterpolation 
{
public:
