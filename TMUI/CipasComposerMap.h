...
class TMUI_EXPORT CCipasComposerMap :public CComposerItem
{
	Q_OBJECT
public:
	/** Constructor. */
	CCipasComposerMap( CCipasComposition *composition, int x, int y, int width, int height );
	/** Constructor. Settings are read from project. */
	CCipasComposerMap(CCipasComposition *composition);
	~CCipasComposerMap(void);
	...
	int id() const {return mId;}
	  ...
	  void draw( QPainter *painter, const CCipasRectangle& extent, const QSize& size, int dpi );
    ...
    void setNewExtent( const CCipasRectangle& extent );
    ...
    CCipasRectangle extent() const {return mExtent;}

    const CCipasMapRenderer* mapRenderer() const {return mMapRenderer;}
  ...
  private:
    ...
    CCipasMapRenderer *mMapRenderer;
    ...
    void requestedExtent( CCipasRectangle& extent ) const;
