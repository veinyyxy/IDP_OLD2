...
class TMUI_EXPORT CComposerItem :public QObject, public QGraphicsRectItem
{
	Q_OBJECT
public:
	enum ItemType
    ...
    CComposerItem( CCipasComposition* composition, bool manageZValue = true );
    /**Constructor with box position and composer object
     ...
     @param composition parent composition
     @param manageZValue true if the z-Value of this object should be managed by mComposition*/
    CComposerItem( qreal x, qreal y, qreal width, qreal height, CCipasComposition* composition, bool manageZValue = true );
	virtual ~CComposerItem(void);
    ...
    virtual void addItem( CComposerItem* item ) { Q_UNUSED( item ); }
    virtual void removeItems() {}

    const CCipasComposition* composition() const {return mComposition;}

    /**Starts new composer undo command
      @param commandText command title
      @param c context for mergeable commands (unknown for non-mergeable commands*/
    void beginCommand( const QString& commandText, CipasComposerMergeCommand::Context c = CipasComposerMergeCommand::Unknown );
	...
	double textHeightMillimeters( const QFont& font, const QString& text ) const;
  ...
  protected:
    ...
    CComposerItem::MouseMoveAction mCurrentMouseMoveAction;
    ...
    CComposerItem::MouseMoveAction mouseMoveActionForPosition( const QPointF& itemCoordPos );
